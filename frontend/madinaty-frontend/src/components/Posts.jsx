      ...
      <div className="flex flex-col justify-center w-full mb-12  max-w-md">
        <div className="flex flex-row justify-between items-start">
          ...
          <div className="px-2  py-4 ">
            {/* <img
              src={menu}
              className="h-[20px] opacity-50 active:opacity-80 cursor-pointer"
            /> */}
            <OptionsMenu />
          </div>
        </div>
        ...
        <div className="w-full flex flex-row gap-3 justify-between items-center">
          <div className="bg-gray-300 hover:scale-103 hover:bg-[#c7c6cd] cursor-pointer  active:bg-gray-400 active:scale-95 transition duration-[0.1s] w-1/3 h-[36px] flex flex-row justify-center items-center rounded-[18px]">
